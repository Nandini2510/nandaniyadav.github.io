<script lang="ts">
  ...
  <section>
    ...
    <div class="w-full mb-4">
      ...
      <Wrappper>
        <div class="w-full text-center mx-auto my-10 md:my-12 lg:my-16 w-full">
          ...
          <div class="flex flex-wrap justify-center gap-4 lg:gap-5 xl:gap-6">
              ...
              <a href="https://www.coursera.org/account/accomplishments/certificate/JUU65FDCWLU5" target="_blank" class="w-full md:w-[48.5%]">
                <Saos animation={'scale-up-center 1s cubic-bezier(0.4, 0, 0.2, 1) both'} once>
                    <a href="https://drive.google.com/file/d/1DQEsW2AXUxfsgKT5nKnbPrG2VXihInCO/view?usp=drive_link" target="_blank">
                        <Button noDarkVariant={false} fullWidth={true}>
                          <Fa icon={faExternalLink} slot="icon" />REsume
                        </Button>
                      </a>
                </Saos>
              </a>
